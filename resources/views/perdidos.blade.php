...
<body>
    <div class="container mt-5">
        <div class="pedido-details">
            ...
            <p><strong>Fecha:</strong> 11 de noviembre de 2024</p>
            <p><strong>Total:</strong> $576.19</p>
            <p><strong>Enviar a:</strong> Paola Samaniego</p>
            <p><strong>Pedido n.º</strong> 701-5806216-5046646</p>
            <button class="btn btn-primary btn-custom">Ver detalles del pedido</button>
            <button class="btn btn-secondary btn-custom">Factura</button>
        </div>

        <div class="mt-4">
            <h4>Productos en tu pedido</h4>
            <div class="producto d-flex">
                <img src="./img/capturadora.jpg" alt="Capturadora Yostyle">
                <div>
                    <h5>Yostyle Capturadora de Video HDMI a USB 2.0</h5>
                    <p>Convertidor Video Audio Game Capture 1080P 60FPS, Tarjeta de Captura para Transmisión, Transmisión en Vivo, Videoconferencias, Enseñanza, Juegos</p>
                    <small>Entregado el 14 de noviembre</small>
                    <button class="btn btn-outline-primary btn-custom">Ver tu artículo</button>
                    <button class="btn btn-outline-info btn-custom">Realizar seguimiento de paquete</button>
                    <button class="btn btn-outline-danger btn-custom">Devolver productos</button>
                </div>
            </div>
            <div class="producto d-flex">
                <img src="./img/regulador.jpg" alt="Koblenz REGULADOR">
                <div>
                    <h5>Koblenz REGULADOR RS-1410</h5>
                    <p>1410 VA / 700 Watts (SUSTITUTO del RE-110), 8 Cont REGULADOS Y ATERRIZADOS, DESC EN Alto Voltaje, Interruptor EN Encendido Y APAG DE Uso RUDO, 108-132 V, Garantía 2 AÑOS</p>
                    <small>Entregado el 14 de noviembre</small>
                    <button class="btn btn-outline-primary btn-custom">Ver tu artículo</button>
                    <button class="btn btn-outline-info btn-custom">Realizar seguimiento de paquete</button>
                    <button class="btn btn-outline-danger btn-custom">Devolver productos</button>
        ...
        <div class="mt-4">
            <h4>Opciones de productos</h4>
            <button class="btn btn-success btn-custom">Comprar nuevamente</button>
            <button class="btn btn-warning btn-custom">Evaluar al vendedor</button>
            <button class="btn btn-info btn-custom">Escribir una opinión sobre el producto</button>
        </div>
    </div>
  </div>
