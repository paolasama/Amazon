...
window.navmet.tmp=+new Date(); /*<!-- Navyaan SWM -->*/ 
...
window.$Nav && $Nav.when("data").run(function(data) { data({"timelineTimeout":{"html":"<div id='nav-timeline'><div id='nav-timeline-error-content'><span class='nav-title'>Thereâ?s a problem showing your shopping history right now</span><p class='nav-paragraph'>Please check your network connection or come back in a few minutes.</p></div></div>"}}); });
...
, filterAliases: []
, pageType: "Gateway"
, requestId: "4VPSW8Q0YWEHRCNMWVZS"
, sessionId: "143-6894137-3397439"
, language: "es_MX"
, customerId: "A1G8SE7ONYCIC5"
, asin: ""
, b2b: 0
, fresh: 0
, isJpOrCn: 0
...
window.$Nav && $Nav.declare('config.sessionId','143\x2D6894137\x2D3397439');
window.$Nav && $Nav.declare('config.requestId','4VPSW8Q0YWEHRCNMWVZS');

window.$Nav && $Nav.declare('config.alexaListEnabled',false);

window.$Nav && $Nav.declare('config.readyOnATF',true);

window.$Nav && $Nav.declare('config.dynamicMenuArgs',{"rid":"4VPSW8Q0YWEHRCNMWVZS","isFullWidthPrime":0,"isPrime":0,"dynamicRequest":1,"weblabs":"","isFreshRegionAndCustomer":"","primeMenuWidth":310});

window.$Nav && $Nav.declare('config.customerName','paola');

window.$Nav && $Nav.declare('config.customerCountryCode',null);

window.$Nav && $Nav.declare('config.yourAccountPrimeURL','https\x3A\x2F\x2Fwww.amazon.com.mx\x2Fgp\x2Fcss\x2Forder\x2Dhistory\x2Futils\x2Ffirst\x2Dorder\x2Dfor\x2Dcustomer.html\x2Fref\x3Dya_prefetch_beacon\x3Fie\x3DUTF8\x26s\x3D143\x2D6894137\x2D3397439');
...
window.$Nav && $Nav.declare('config.hashCustomerAndSessionId','cd780462ecb51471d7829684067ef2ca9b571a5c');
...
/*este diseño para la pagina*/

window.GWI && GWI.AssetUtil && GWI.AssetUtil.load([{"type":"image","src":"https://m.media-amazon.com/images/I/51cbHetLTRL._SX1500_.jpg"}]);
...
P.when("LinkDecorator").execute("LDEventListenerInit", function(ld){ ld("pageContent"); })
             //<![CDATA[
               window.P && P.when('herotator').execute(function heroBtf(h) {
                 var btfContent = [{"fgID":"desktop-hero-2","content":"<link rel=\"stylesheet\" href=\"https://images-na.ssl-images-amazon.com/images/I/11WF6HHUCwL.css?xcp\" />\n<!--CardsClient--><div class=\"a-section a-spacing-none _cropped-image-map_style_cropped-image-map__3oVAB\" id=\"CardInstancew12tklH1hRMgz0nSd84ohg\" data-card-metrics-id=\"cropped-image-map_desktop-gateway-atf_1\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluid-image-map-container__3GBMh\"><div class=\"a-section a-spacing-none _cropped-image-map_style_image-map__12oiu\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluidImageContainer__2jd50\"><img alt=\"PED\" src=\"https://m.media-amazon.com/images/I/61oJNLkgVNL._SX1500_.jpg\" class=\"_cropped-image-map_style_fluidLandscapeImage__3eTVC \n _cropped-image-map_style_fluidImage__iJ3aE\" data-a-hires=\"https://m.media-amazon.com/images/I/71hyb0CdtWL._SX3000_.jpg\"/><\/div><a href=\"/rappipro/?_encoding=UTF8&amp;pd_rd_w=ZJE9m&amp;content-id=amzn1.sym.873b4b86-2c14-4525-a2ac-f97353365e11&amp;pf_rd_p=873b4b86-2c14-4525-a2ac-f97353365e11&amp;pf_rd_r=N29W8X1MECJA8MJ0WJ1E&amp;pd_rd_wg=i8S86&amp;pd_rd_r=71064a41-75c7-47a4-8a19-b4723c106383&amp;ref_=pd_hp_d_hero_unk\" style=\"position:absolute;left:0%;top:0%;width:100%;height:50%\" target=\"\" aria-label=\"Rappi\"><\/a><\/div><\/div><\/div><script>(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstancew12tklH1hRMgz0nSd84ohg');}}));<\/script>\n"},{"fgID":"desktop-hero-3","content":"<link rel=\"stylesheet\" href=\"https://images-na.ssl-images-amazon.com/images/I/11WF6HHUCwL.css?xcp\" />\n<!--CardsClient--><div class=\"a-section a-spacing-none _cropped-image-map_style_cropped-image-map__3oVAB\" id=\"CardInstancexsvVe3z0w4kgWwx3BDMNQA\" data-card-metrics-id=\"cropped-image-map_desktop-gateway-atf_2\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluid-image-map-container__3GBMh\"><div class=\"a-section a-spacing-none _cropped-image-map_style_image-map__12oiu\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluidImageContainer__2jd50\"><img alt=\"Hasta 20% en Halloween y Día de Muertos\" src=\"https://m.media-amazon.com/images/I/51hrd+cE+ZL._SX1500_.jpg\" class=\"_cropped-image-map_style_fluidLandscapeImage__3eTVC \n _cropped-image-map_style_fluidImage__iJ3aE\" data-a-hires=\"https://m.media-amazon.com/images/I/71liaCvV+-L._SX3000_.jpg\"/><\/div><a href=\"/gcx/Halloween-y-D%C3%ADa-de-Muertos/gfhz/events/?_encoding=UTF8&amp;_encoding=UTF8&amp;categoryId=Halloween-Main-Event&amp;scrollState=eyJpdGVtSW5kZXgiOjAsInNjcm9sbE9mZnNldCI6MjEzLjc4MzM0MDQ1NDEwMTU2fQ%3D%3D&amp;sectionManagerState=eyJzZWN0aW9uVHlwZUVuZEluZGV4Ijp7ImFtYWJvdCI6MH19&amp;pd_rd_w=SxgmX&amp;content-id=amzn1.sym.6adc7779-c49d-47c6-8ba2-b1bde243bfe7&amp;pf_rd_p=6adc7779-c49d-47c6-8ba2-b1bde243bfe7&amp;pf_rd_r=N29W8X1MECJA8MJ0WJ1E&amp;pd_rd_wg=i8S86&amp;pd_rd_r=71064a41-75c7-47a4-8a19-b4723c106383&amp;ref_=pd_hp_d_hero_unk\" style=\"position:absolute;left:0%;top:0%;width:200%;height:50%\" target=\"\" aria-label=\"Hasta 20% en Halloween y Día de Muertos\"><\/a><\/div><\/div><\/div><script>(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstancexsvVe3z0w4kgWwx3BDMNQA');}}));<\/script>\n"},{"fgID":"desktop-hero-4","content":"<link rel=\"stylesheet\" href=\"https://images-na.ssl-images-amazon.com/images/I/11WF6HHUCwL.css?xcp\" />\n<!--CardsClient--><div class=\"a-section a-spacing-none _cropped-image-map_style_cropped-image-map__3oVAB\" id=\"CardInstancekzwxxaTHFHMT0PxC2cougA\" data-card-metrics-id=\"cropped-image-map_desktop-gateway-atf_3\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluid-image-map-container__3GBMh\"><div class=\"a-section a-spacing-none _cropped-image-map_style_image-map__12oiu\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluidImageContainer__2jd50\"><img alt=\"Bolsas desde $199\" src=\"https://m.media-amazon.com/images/I/612FJLFBDgL._SX1500_.jpg\" class=\"_cropped-image-map_style_fluidLandscapeImage__3eTVC \n _cropped-image-map_style_fluidImage__iJ3aE\" data-a-hires=\"https://m.media-amazon.com/images/I/61Kk8dlcgCL._SX3000_.jpg\"/><\/div><a href=\"/s/?_encoding=UTF8&amp;k=bolsas&amp;i=fashion&amp;rh=n%3A122271351011%2Cp_36%3A19900-&amp;pd_rd_w=xbymN&amp;content-id=amzn1.sym.cc683833-4a7e-4a58-a523-c4571e7bde5c&amp;pf_rd_p=cc683833-4a7e-4a58-a523-c4571e7bde5c&amp;pf_rd_r=N29W8X1MECJA8MJ0WJ1E&amp;pd_rd_wg=i8S86&amp;pd_rd_r=71064a41-75c7-47a4-8a19-b4723c106383&amp;ref_=pd_hp_d_hero_unk\" style=\"position:absolute;left:0%;top:0%;width:200%;height:50%\" target=\"\" aria-label=\"Bolsas desde $199\"><\/a><\/div><\/div><\/div><script>(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstancekzwxxaTHFHMT0PxC2cougA');}}));<\/script>\n"},{"fgID":"desktop-hero-5","content":"<link rel=\"stylesheet\" href=\"https://images-na.ssl-images-amazon.com/images/I/11WF6HHUCwL.css?xcp\" />\n<!--CardsClient--><div class=\"a-section a-spacing-none _cropped-image-map_style_cropped-image-map__3oVAB\" id=\"CardInstance_2xaWx_VYPDjiyfULfH4nA\" data-card-metrics-id=\"cropped-image-map_desktop-gateway-atf_4\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluid-image-map-container__3GBMh\"><div class=\"a-section a-spacing-none _cropped-image-map_style_image-map__12oiu\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluidImageContainer__2jd50\"><img alt=\"Hasta 20% en alimento | Hasta 40% en accesorios\" src=\"https://m.media-amazon.com/images/I/51-x-in7pTL._SX1500_.jpg\" class=\"_cropped-image-map_style_fluidLandscapeImage__3eTVC \n _cropped-image-map_style_fluidImage__iJ3aE\" data-a-hires=\"https://m.media-amazon.com/images/I/71Qmsbc6B6L._SX3000_.jpg\"/><\/div><a href=\"/b/?ie=UTF8&amp;node=122326885011&amp;mode=preview&amp;languageTags=es-MX&amp;language=es-MX&amp;slot_mobile-hybrid-4=A4-%2Fsymphony%2Fpreview%2Fd390503d%2Fd390503d-c06a-443b-a04b-e60de6d1ce21%2FdefaultLocale.xml%3F1725665686141&amp;isTest=true&amp;discounts-widget=%2522%257B%255C%2522state%255C%2522%253A%257B%255C%2522refinementFilters%255C%2522%253A%257B%257D%257D%252C%255C%2522version%255C%2522%253A1%257D%2522&amp;promotionsSearchStartIndex=14&amp;promotionsSearchLastSeenAsin=B0CG3223XZ&amp;pd_rd_w=2uATH&amp;content-id=amzn1.sym.21158205-e2c0-4617-92ea-b237922e8687&amp;pf_rd_p=21158205-e2c0-4617-92ea-b237922e8687&amp;pf_rd_r=N29W8X1MECJA8MJ0WJ1E&amp;pd_rd_wg=i8S86&amp;pd_rd_r=71064a41-75c7-47a4-8a19-b4723c106383&amp;ref_=pd_hp_d_hero_unk#mobile-hybrid-4\" style=\"position:absolute;left:0%;top:0%;width:200%;height:50%\" target=\"\" aria-label=\"Descuentos en mascotas\"><\/a><\/div><\/div><\/div><script>(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstance_2xaWx_VYPDjiyfULfH4nA');}}));<\/script>\n"},{"fgID":"desktop-hero-6","content":"<link rel=\"stylesheet\" href=\"https://images-na.ssl-images-amazon.com/images/I/11WF6HHUCwL.css?xcp\" />\n<!--CardsClient--><div class=\"a-section a-spacing-none _cropped-image-map_style_cropped-image-map__3oVAB\" id=\"CardInstanceb3r7i8A8w8CTcA3IcsBpvQ\" data-card-metrics-id=\"cropped-image-map_desktop-gateway-atf_5\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluid-image-map-container__3GBMh\"><div class=\"a-section a-spacing-none _cropped-image-map_style_image-map__12oiu\"><div class=\"a-section a-spacing-none _cropped-image-map_style_fluidImageContainer__2jd50\"><img alt=\"Pagos en quincenas con Kueski Pay\" src=\"https://m.media-amazon.com/images/I/51rJ4ltMcaL._SX1500_.jpg\" class=\"_cropped-image-map_style_fluidLandscapeImage__3eTVC \n _cropped-image-map_style_fluidImage__iJ3aE\" data-a-hires=\"https://m.media-amazon.com/images/I/61SY2MaDWGL._SX3000_.jpg\"/><\/div><a href=\"/b/?ie=UTF8&amp;node=119644544011&amp;pd_rd_w=M0kGs&amp;content-id=amzn1.sym.2d021999-b988-45f4-8001-099538feed1e&amp;pf_rd_p=2d021999-b988-45f4-8001-099538feed1e&amp;pf_rd_r=N29W8X1MECJA8MJ0WJ1E&amp;pd_rd_wg=i8S86&amp;pd_rd_r=71064a41-75c7-47a4-8a19-b4723c106383&amp;ref_=pd_hp_d_hero_unk\" style=\"position:absolute;left:0%;top:0%;width:200%;height:50%\" target=\"\" aria-label=\"Pagos en quincenas\"><\/a><\/div><\/div><\/div><script>(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstanceb3r7i8A8w8CTcA3IcsBpvQ');}}));<\/script>\n"},{"fgID":"desktop-hero-7","content":"<link rel=\"stylesheet\" href=\"https://images-na.ssl-images-amazon.com/images/I/41VxnYG+75L.css?xcp\" />\n<!--CardsClient--><div class=\"a-section a-spacing-none _cropped-image-link_style_cropped-image-link__3winf\" id=\"CardInstanceY2YRSdihyKlTBceEzY2bfQ\" data-card-metrics-id=\"cropped-image-link_desktop-gateway-atf_6\"><a class=\"a-link-normal _cropped-image-link_style_centerImage__1rzYI aok-block image-window\" href=\"/gp/video/ssoredirect/?ie=UTF8&amp;pvp=%2Fdetail%2Famzn1.dv.gti.39f06f45-c884-4f38-bf82-53e68b17ee96%2F%3Fref_%3Ddvm_crs_gat_mx_c_dt_gw0o_l_al_htco_tp&amp;pd_rd_w=0vD2v&amp;content-id=amzn1.sym.3b992405-c908-4222-a924-2cbea9825aa1&amp;pf_rd_p=3b992405-c908-4222-a924-2cbea9825aa1&amp;pf_rd_r=N29W8X1MECJA8MJ0WJ1E&amp;pd_rd_wg=i8S86&amp;pd_rd_r=71064a41-75c7-47a4-8a19-b4723c106383&amp;ref_=pd_hp_d_hero_unk\"><div class=\"a-section a-spacing-none _cropped-image-link_style_fluidImageContainer__2jd50\"><img alt=\"Hotel Cocaína. Ver con una suscripción adicional. Channels | MGM+. Prime Video.\" src=\"https://m.media-amazon.com/images/I/513D30+bt+L._SX1500_.jpg\" class=\"_cropped-image-link_style_fluidLandscapeImage__3eTVC \n _cropped-image-link_style_fluidImage__iJ3aE\" data-a-hires=\"https://m.media-amazon.com/images/I/713DD6RlGHL._SX3000_.jpg\"/><\/div><div class=\"_cropped-image-link_style_dt-TextContainer__3nbU9\"><style>._cropped-image-link_style_dt-TextContainer__3nbU9 {--text-pos-y: 30px; --text-pos-x: 320px; --text-width: 50%; --title-text-width: 50%; --subtitle-text-width: 50%; --title-font-color: #FFFFFF; --title-font-size: 44px; --title-font-weight: 700; --subtitle-font-color: #FFFFFF; --subtitle-font-size: 36px; --subtitle-font-weight: 700; --subtitle-margin-top: 4px; --cta-font-size: 14px; --cta-margin-top: 20px; --legal-line-font-color: #FFFFFF; --legal-line-font-size: 14px; --legal-line-margin-top: 14px; }<\/style><\/div><\/a><\/div><script>(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstanceY2YRSdihyKlTBceEzY2bfQ');}}));<\/script>\n"},{"fgID":"desktop-hero-8","content":"<link rel=\"stylesheet\" href=\"https://images-na.ssl-images-amazon.com/images/I/41VxnYG+75L.css?xcp\" />\n<!--CardsClient--><div class=\"a-section a-spacing-none _cropped-image-link_style_cropped-image-link__3winf\" id=\"CardInstanceMmo54QYPIpBvAIsEPTJo6g\" data-card-metrics-id=\"cropped-image-link_desktop-gateway-atf_7\"><a class=\"a-link-normal _cropped-image-link_style_centerImage__1rzYI aok-block image-window\" href=\"/r/?_encoding=UTF8&amp;aid=LT88a17YTImP9jiC1tlsfg&amp;dest=https%3A%2F%2Fwww.amazon.com.mx%2Fmusic%2Fplayer%2Fplaylists%2FB08T6BZ5HF%3Fref%3Ddmm_gw_her_d_amu_acq_genmex_0927_mx&amp;pd_rd_w=LJXtO&amp;content-id=amzn1.sym.3cf2734c-33f3-4929-95b0-73348aee3153&amp;pf_rd_p=3cf2734c-33f3-4929-95b0-73348aee3153&amp;pf_rd_r=N29W8X1MECJA8MJ0WJ1E&amp;pd_rd_wg=i8S86&amp;pd_rd_r=71064a41-75c7-47a4-8a19-b4723c106383&amp;ref_=pd_hp_d_hero_unk\"><div class=\"a-section a-spacing-none _cropped-image-link_style_fluidImageContainer__2jd50\"><img alt=\"GEN MEX\" src=\"https://m.media-amazon.com/images/I/51YaYeUmA8L._SX1500_.jpg\" class=\"_cropped-image-link_style_fluidLandscapeImage__3eTVC \n _cropped-image-link_style_fluidImage__iJ3aE\" data-a-hires=\"https://m.media-amazon.com/images/I/61BM6YUFvxL._SX3000_.jpg\"/><\/div><div class=\"_cropped-image-link_style_dt-TextContainer__3nbU9\"><style>._cropped-image-link_style_dt-TextContainer__3nbU9 {--text-pos-y: 30px; --text-pos-x: 320px; --text-width: 50%; --title-text-width: 50%; --subtitle-text-width: 50%; --title-font-color: #FFFFFF; --title-font-size: 44px; --title-font-weight: 700; --subtitle-font-color: #FFFFFF; --subtitle-font-size: 36px; --subtitle-font-weight: 700; --subtitle-margin-top: 4px; --cta-font-size: 14px; --cta-margin-top: 20px; --legal-line-font-color: #FFFFFF; --legal-line-font-size: 14px; --legal-line-margin-top: 14px; }<\/style><\/div><\/a><\/div><script>(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstanceMmo54QYPIpBvAIsEPTJo6g');}}));<\/script>\n"}];
                   h(btfContent);
               });
             //]]>

GwInstrumentation.markH1Af({ uri: "/ah/ajax/counter?ctr=desktop_ajax_atf&exp=1727911331148&rId=N29W8X1MECJA8MJ0WJ1E&mkId=A1AM78C64UM0Y8&h=ccc5833e304eca047dcb5aba22c85be4ca2a2035b8fa66233a76178f04fb7a10" })
...
(function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstancevxT3vdiyFwXxIjVos2GYkQ');}}));
P.when('af').execute(function(){P.load.js('https://images-na.ssl-images-amazon.com/images/I/11Tp9vaeEJL.js?xcp');
      });
if(window.mixTimeout){window.mixTimeout('quad-multi-asin-card-v2', 'CardInstancevxT3vdiyFwXxIjVos2GYkQ', 90000)};
      P.when('mix:@amzn/mix.client-runtime', 'mix:quad-multi-asin-card-v2__KKowH-mU').execute(function (runtime, cardModule) {runtime.registerCardFactory('CardInstancevxT3vdiyFwXxIjVos2GYkQ', cardModule);if(window.GWI){window.GWI.Card.autoInstActive('CardInstancevxT3vdiyFwXxIjVos2GYkQ');}});
//aqui los productos
        ...
        window.$Nav && $Nav.when("data").run(function (data) {
          data({
            "accountListContent": { "html": "<div id='nav-al-container'><div id='nav-al-signin'><div id='nav-flyout-ya-signin' class='nav-flyout-content nav-flyout-accessibility'><a href='https://www.amazon.com.mx/ap/signin?openid.pape.max_auth_age=0&openid.return_to=https%3A%2F%2Fwww.amazon.com.mx%2F%3F_encoding%3DUTF8%26ref_%3Dnav_signin&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.assoc_handle=mxflex&openid.mode=checkid_setup&openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0' rel='nofollow' class='nav-action-signin-button' data-nav-role='signin' data-nav-ref='nav_signin'><span class='nav-action-inner'>Identificarse</span></a><div id='nav-flyout-ya-newCust' class='nav_pop_new_cust nav-flyout-content nav-flyout-accessibility'>¿Eres un cliente nuevo? <a href='https://www.amazon.com.mx/ap/register?openid.pape.max_auth_age=0&openid.return_to=https%3A%2F%2Fwww.amazon.com.mx%2F%3F_encoding%3DUTF8%26ref_%3Dnav_newcust&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.assoc_handle=mxflex&openid.mode=checkid_setup&openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0' rel='nofollow' class='nav-a'>Empieza aquí.</a></div></div></div><div id='nav-al-wishlist' class='nav-al-column nav-tpl-itemList nav-flyout-content nav-flyout-accessibility'><div class='nav-title' id='nav-al-title' role='heading' aria-level='6'>Listas</div><a href='/hz/wishlist/ls?triggerElementID=createList&ref_=nav_ListFlyout_navFlyout_createList_lv_redirect' class='nav-link nav-item'><span class='nav-text'>Crear una Wish List</span></a> <a href='/baby-reg/homepage?ref_=nav_ListFlyout_baby_registry' class='nav-link nav-item'><span class='nav-text'>Mesa de Regalos de Bebé</span></a> <a href='/wedding/home?ref_=nav_ListFlyout_wr' class='nav-link nav-item'><span class='nav-text'>Mesa de Regalos de Boda</span></a></div><div id='nav-al-your-account' class='nav-al-column nav-template nav-flyout-content nav-tpl-itemList nav-flyout-accessibility'><div class='nav-title' role='heading' aria-level='6'>Mi cuenta</div><a href='/gp/css/homepage.html?ref_=nav_AccountFlyout_ya' class='nav-link nav-item'><span class='nav-text'>Mi cuenta</span></a> <a id='nav_prefetch_yourorders' href='/gp/css/order-history?ref_=nav_AccountFlyout_orders' class='nav-link nav-item'><span class='nav-text'>Mis pedidos</span></a> <a href='/gp/yourstore?ref_=nav_AccountFlyout_recs' class='nav-link nav-item'><span class='nav-text'>Mis recomendaciones</span></a> <a href='/gp/primecentral?ref_=nav_AccountFlyout_prime' class='nav-link nav-item'><span class='nav-text'>Mi membresía Prime</span></a> <a href='/auto-deliveries?ref_=nav_AccountFlyout_sns' class='nav-link nav-item'><span class='nav-text'>Mi Planea y Ahorra</span></a> <a href='/hz5/yourmembershipsandsubscriptions?ref_=nav_AccountFlyout_digital_subscriptions' class='nav-link nav-item'><span class='nav-text'>Membresías y suscripciones</span></a> <a href='/hz/mycd/myx?pageType=content&ref_=nav_AccountFlyout_myk' class='nav-link nav-item'><span class='nav-text'>Mi contenido Kindle</span></a> <a href='https://music.amazon.com.mx?ref=nav_youraccount_cldplyr' class='nav-link nav-item'><span class='nav-text'>Mi Amazon Music</span></a> <a href='/gp/video/ssoredirect?pvp=/ref%3Dnav_youraccount_apv&ref_=nav_AccountFlyout__apv' class='nav-link nav-item'><span class='nav-text'>Mi Prime Video</span></a> <a href='/business/register/org/landing?ref_=nav_AccountFlyout_b2b_reg_bottom' class='nav-link nav-item'><span class='nav-text'>Registrarte para una Cuenta de Negocios gratis</span></a></div></div>" },
            "tooltipContent": { "html": "" },
            "signinContent": { "html": "<div id='nav-signin-tooltip'><a href='https://www.amazon.com.mx/ap/signin?openid.pape.max_auth_age=0&openid.return_to=https%3A%2F%2Fwww.amazon.com.mx%2F%3F_encoding%3DUTF8%26ref_%3Dnav_custrec_signin&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.assoc_handle=mxflex&openid.mode=checkid_setup&openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0' class='nav-action-signin-button' data-nav-role='signin' data-nav-ref='nav_custrec_signin'><span class='nav-action-inner'>Identificarse</span></a><div class='nav-signin-tooltip-footer'>¿Eres un cliente nuevo? <a href='https://www.amazon.com.mx/ap/register?openid.pape.max_auth_age=0&openid.return_to=https%3A%2F%2Fwww.amazon.com.mx%2F%3F_encoding%3DUTF8%26ref_%3Dnav_custrec_newcust&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.assoc_handle=mxflex&openid.mode=checkid_setup&openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0' class='nav-a'>Empieza aquí.</a></div></div>" },
    ...
    (function(f){var l=window.AmazonUIPageJS||window.P,k=l._namespace||l.attributeErrors,h=k?k("DossierComponentLibraryAssets@carousel","DossierComponentLibraryAssets"):l;h.guardFatal?h.guardFatal(f)(h,window):h.execute(function(){f(h,window)})})(function(f,l,k){var h="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(c){return typeof c}:function(c){return c&&"function"===typeof Symbol&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c};try{f.when("A","a-carousel-constants",
    "a-carousel-strategies-transition").register("dds/carousel-slide-no-empty-space",function(c,e,f){if(c.capabilities.touch){var d=function(){var a=c.extend({},f.none),b=a.init;a.init=function(a){b&&b.call(this,a);a.dom.$container.addClass("a-carousel-transition-none")};return{v:a}}();if("object"===("undefined"===typeof d?"undefined":h(d)))return d.v}var d=c.extend({},f.slideHorizontal),n=function(a,b){b.silent||b.animationDuration&&!(0<b.animationDuration)||a.setAttr(e.ANIMATING,!0)},q=function(a){var b=
    function(){c.delay(function(){a.dom.$container.find(".a-carousel-card").attr("aria-hidden","false")},0)};b();c.on("a:carousel:repaint",b);a.onChange(e.ANIMATING,b)},r=function(a){var b=function(a){a.attr("aria-hidden",!0);a.attr("tabindex",-1)};b(a.find(".a-carousel-goto-prevpage"));b(a.find(".a-carousel-goto-nextpage"))},t=function(a){var b=a.dom.$container;c.capabilities.isSafari&&!b.data("pageshow-on-safari-registered")&&(b.data("pageshow-on-safari-registered",!0),c.$(l).bind("pageshow",function(b){b.originalEvent.persisted&&
    a.resize()}))};d.gotoPrevPage=function(a){var b=1<arguments.length&&arguments[1]!==k?arguments[1]:{};b.isGoingBack=!0;var m=a.getAttr(e.PAGE_NUMBER);this.gotoPage(a,m-1,b)};d.gotoPage=function(a,b){var m=2<arguments.length&&arguments[2]!==k?arguments[2]:{};n(a,m);var c=a.getAttr(e.TOTAL_PAGES),g=a.getAttr(e.PAGE_SIZE),d=a.getAttr(e.SET_SIZE);b=Math.max(1,Math.min(b,c));var f=Math.min(g*(b-1)+1,d-g+1);f+g>d&&(b=m.isGoingBack?Math.max(1,b-1):c,f=Math.min(g*(b-1)+1,d-g+1));a.setAttr(e.PAGE_NUMBER,b);
    this.gotoIndex(a,f,m)};d.gotoIndex=function(a,b){var c=2<arguments.length&&arguments[2]!==k?arguments[2]:{};n(a,c);a.setAttr(e.FIRST_VISIBLE_ITEM,b);a.setAttr("currentGutter",a.getAttr(e.MIN_GUTTER));var d=a.getItemOffset(b),g=a.getAttr(e.PAGE_SIZE),f=a.getAttr(e.SET_SIZE);b+g>f&&(a.setAttr(e.PAGE_NUMBER,a.getAttr(e.TOTAL_PAGES)),d-=a.getViewportWidth()-(a.getDimensions().carousel.width-d));this.gotoPixel(a,d,c);0===a.dom.$viewport.find(".dcl-product-wrapper").length&&a.dom.$viewport.find("ol.a-carousel").css("height",
    a.dom.$viewport.height()+"px")};var p=d.init;d.init=function(a){p&&p.call(this,a);a.setAttr("auto_adjust_height",!1);var b=a.dom.$container;a.setAttr("maintain_state",!1);t(a);q(a);r(b);b.delegate(".a-carousel-card","touchstart mousedown",function(a){c.$(a.target).closest(".a-carousel-card").data("manual-click",!0)});b.delegate(".a-carousel-card","focus",function(b){var d=c.$(b.target).closest(".a-carousel-card");if(d.data("manual-click"))d.data("manual-click",!1);else{c.delay(function(){d.parent()[0].scrollIntoView({block:"nearest",
    inline:"start"})},50);b=d.index()+1;var g=a.getAttr(e.FIRST_VISIBLE_ITEM),f=a.getAttr(e.PAGE_SIZE);(b>=g+f||b<g)&&a.gotoPage(Math.ceil(b/f))}});a.onChange(e.PAGE_SIZE,function(b){var c=a.getAttr(e.PAGE_NUMBER),d=a.getAttr(e.SET_SIZE);b=Math.ceil(d/b);a.setAttr(e.TOTAL_PAGES,b);d=a.dom.$container;d.find(".a-carousel-goto-prevpage").attr("aria-disabled",1>=c);d.find(".a-carousel-goto-nextpage").attr("aria-disabled",c>=b)})};return d}),f.when("A","a-carousel-framework","dds/carousel-slide-no-empty-space").execute(function(c,
    e,f){e.registerStrategy("transition","dds-slide-no-empty-space",f)})}catch(c){}});(function(e){var f=window.AmazonUIPageJS||window.P,g=f._namespace||f.attributeErrors,c=g?g("DossierShowcaseAssets@carousel","DossierShowcaseAssets"):f;c.guardFatal?c.guardFatal(e)(c,window):c.execute(function(){e(c,window)})})(function(e,f,g){(function(){var c=function(d){return 9<d?String(d):"0".concat(d)},g=function(d,a){var b=Number(d.dataset.targetTime);if(Number.isNaN(b))return function(){};h(d,b);var l=Date.now(),k=a(function(){var a=Date.now()-l;a=b-a;0>=a?clearInterval(k):h(d,a)},500);return function(){return clearInterval(k)}},
    h=function(d,a){if(0>=a)var b="00:00";else b=Math.floor(a/36E5),a=[Math.floor(a/6E4%60),Math.floor(a/1E3%60)],b=(0<b&&a.unshift(b),a.map(c).join(":"));d.innerText=b},m=function(d){return function(a,b){return function(a){Array.prototype.slice.call(a.querySelectorAll("[data-component\x3d'dui-badge']")).forEach(function(a){a&&32<a.offsetHeight&&(null==a||a.setAttribute("data-align","vertical"))})}(a),function(a,b){var d=Array.prototype.slice.call(a.querySelectorAll("[data-component\x3d'badge-countdown-timer']")).map(function(a){return g(a,
    b)});return function(){return d.forEach(function(a){return a()})}}(a,b)}(d,f.setInterval)};try{(function(){var d=function(a){return!(a.offsetWidth||a.offsetHeight||a.getClientRects().length)};e.when("A","a-carousel-constants","a-carousel-strategies-display").register("dds/carousel-inline-hero",function(a,b,c){b=a.extend({},c.stretchyGoodness);var e=b.init,f=function(b){var c=0,e=b.dom.$container.find(".dcl-carousel-element");Array.from(e).some(d)||(e.each(function(a,b){c=Math.max(b.scrollHeight,c)}),
    b.updateDimensionsCache({viewport:{height:c,outerHeight:c}}),b.setAttr("maxHeight",c),a.animate(b.dom.$viewport,{height:c},b.getAttr("height_animation_speed"),"linear"),a.animate(b.dom.$viewport.find("ol.a-carousel").first(),{height:c},b.getAttr("height_animation_speed"),"linear"))};return b.init=function(b){var c=new ResizeObserver(function(a){return f(b)});b.dom.$container.find(".dcl-product-wrapper").toArray().forEach(function(a){return c.observe(a)});0<b.dom.$container.find("[data-component\x3d'dui-badge']").length&&
    m(b.dom.$container[0]);f(b);e&&e.call(this,b);a.fadeIn(b.dom.$container.find(".dcl-carousel-element-hero-link img"),100,"ease-out")},b});e.when("A","a-carousel-framework","dds/carousel-inline-hero").execute(function(a,b,c){b.registerStrategy("display","dds-inline-hero",c)})})()}catch(d){}})()});

    if(window.mixTimeout){window.mixTimeout('quad-multi-asin-card-v2', 'CardInstanceJGJ92dbjhL2FZws4kSNvcA', 90000)};
    P.when('mix:@amzn/mix.client-runtime', 'mix:quad-multi-asin-card-v2__KKowH-mU').execute(function (runtime, cardModule) {runtime.registerCardFactory('CardInstanceJGJ92dbjhL2FZws4kSNvcA', cardModule);if(window.GWI){window.GWI.Card.autoInstActive('CardInstanceJGJ92dbjhL2FZws4kSNvcA');}});
    ...
    if(window.mixTimeout){window.mixTimeout('quad-multi-asin-card-v2', 'CardInstanceHQkC0B0lFbTa1PzKRAM-7w', 90000)};
    P.when('mix:@amzn/mix.client-runtime', 'mix:quad-multi-asin-card-v2__KKowH-mU').execute(function (runtime, cardModule) {runtime.registerCardFactory('CardInstanceHQkC0B0lFbTa1PzKRAM-7w', cardModule);if(window.GWI){window.GWI.Card.autoInstActive('CardInstanceHQkC0B0lFbTa1PzKRAM-7w');}});
    ...
    P.when('af').execute(function(){P.load.js('https://images-na.ssl-images-amazon.com/images/I/11+d9I1l9AL.js?xcp');
    });

    if(window.mixTimeout){window.mixTimeout('ameyal-product-shoveler', 'CardInstanceezEXzFM605cgOKuLoxsc8g', 90000)};
    P.when('mix:@amzn/mix.client-runtime', 'mix:ameyal-product-shoveler__Kvjfy9i1').execute(function (runtime, cardModule) {runtime.registerCardFactory('CardInstanceezEXzFM605cgOKuLoxsc8g', cardModule);if(window.GWI){window.GWI.Card.autoInstActive('CardInstanceezEXzFM605cgOKuLoxsc8g');}});
    
    (function(f){f(P._namespace('gwiAutoInstVisible'));}(function(P) {if(window.GWI){GWI.Card.autoInstVisible('CardInstance58vgRjrT3pNEyWgVqzVSwA');}}));

    if(window.mixTimeout){window.mixTimeout('quad-multi-asin-card-v2', 'CardInstanceTLhV-dqeOaAUTe6zeuCCKQ', 90000)};
    P.when('mix:@amzn/mix.client-runtime', 'mix:quad-multi-asin-card-v2__KKowH-mU').execute(function (runtime, cardModule) {runtime.registerCardFactory('CardInstanceTLhV-dqeOaAUTe6zeuCCKQ', cardModule);if(window.GWI){window.GWI.Card.autoInstActive('CardInstanceTLhV-dqeOaAUTe6zeuCCKQ');}});
    ...
    m(b.dom.$container[0]);f(b);e&&e.call(this,b);a.fadeIn(b.dom.$container.find(".dcl-carousel-element-hero-link img"),100,"ease-out")},b});e.when("A","a-carousel-framework","dds/carousel-inline-hero").execute(function(a,b,c){b.registerStrategy("display","dds-inline-hero",c)})})()}catch(d){}})()});
            ...
            window.renderingWeblabs = Object.assign(window.renderingWeblabs, JSON.parse('{"ADPT_SF_LIGHTADS_REFACTOR_903064":"C","ADPT_SF_ADSP_VIDEO_833419":"C","A2I_HOMEPAGE_CARD_THEMING_360311":"T2","ADPT_SF_CLIENT_LATENCY_2023Q3_737747":"C","ADPT_SF_CLIENT_LATENCY_2023Q1_632539":"C","ADPT_SF_APE_WW_MOBILE_SEARCH_ZOETROPE_EPB_EXP_792200":"C","ADPT_SF_H1_VIDEO_ADS_MOCK_940184":"C","ADPT_SF_PLACEMENT_STYLESHEET_1047425":"C","ADPT_SF_BTR_PIXEL_997225":"T1","ADPT_SF_SERVER_SIDE_SPONSORED_LABEL_998980":"C","ADPT_SF_MASH_API_DEPRECATION_1051249":"C","ADPT_SF_RESIZE_ASPECT_RATIO_909226":"T1","ADPT_SF_USE_ADDETAILS_SCOPE_1025572":"T1","ADPT_SF_DEFAULT_SPONSORED_LABEL_863363":"C","ADPT_SF_ADREPORTER_1058579":"C","ADPT_SF_ENABLE_BLANKADS_DETECTION_990833":"C","ADPT_SF_WD1_VIDEO_ADS_MOCK_1037066":"C","ADPT_SF_TRANSPARENCY_INFO_MANDATORY_FOR_EU_712921":"C"}'));

    
    

    (()=>{function e(e,a,t,r){Object.defineProperty(e,a,{get:t,set:r,enumerable:!0,configurable:!0})}var a="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},r={},n=a.parcelRequirea4c5;null==n&&((n=function(e){if(e in t)return t[e].exports;if(e in r){var a=r[e];delete r[e];var n={id:e,exports:{}};return t[e]=n,a.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,a){r[e]=a},a.parcelRequirea4c5=n);var o=n.register;o("2REd0",function(a,t){e(a.exports,"incrementCsmPlacementCounter",()=>i),e(a.exports,"incrementCsmCounter",()=>d);var r=n("5BC6Z"),o=n("9fPDQ"),i=function(e,a,t){if(void 0===t&&(t=1),!l()){window.safeframe=null!==(n=window.safeframe)&&void 0!==n?n:{},window.safeframe.csmCache=null!==(d=window.safeframe.csmCache)&&void 0!==d?d:{},window.safeframe.csmCache.incrementCsmPlacementCounter=null!==(s=window.safeframe.csmCache.incrementCsmPlacementCounter)&&void 0!==s?s:[],window.safeframe.csmCache.incrementCsmPlacementCounter.push({metric:e,placement:a,count:t});return}null===(v=null===(f=null===(u=window.safeframe)||void 0===u?void 0:u.csmCache)||void 0===f?void 0:f.incrementCsmPlacementCounter)||void 0===v||v.forEach(function(e){return i(e.metric,e.placement,e.count)});var n,d,s,u,f,v,w=function(e,a,t){a&&c("".concat(m(e),":").concat(a),t)};w(e,a.id,t),w(e,(0,r.getPlacementWithBrowseNode)(a.id),t),w(e,(0,o.csmName)(a.name),t),w(e,(0,r.getSlotWithBrowseNode)((0,o.csmName)(a.name)),t)},d=function(e,a){var t,r,n,o,i,s;if(void 0===a&&(a=1),!l()){window.safeframe=null!==(t=window.safeframe)&&void 0!==t?t:{},window.safeframe.csmCache=null!==(r=window.safeframe.csmCache)&&void 0!==r?r:{},window.safeframe.csmCache.incrementCsmCounter=null!==(n=window.safeframe.csmCache.incrementCsmCounter)&&void 0!==n?n:[],window.safeframe.csmCache.incrementCsmCounter.push({metric:e,count:a});return}null===(s=null===(i=null===(o=window.safeframe)||void 0===o?void 0:o.csmCache)||void 0===i?void 0:i.incrementCsmCounter)||void 0===s||s.forEach(function(e){return d(e.metric,e.count)}),c(m(e),a)},l=function(){var e;return"function"==typeof(null===(e=null==window?void 0:window.ue)||void 0===e?void 0:e.count)},c=function(e,a){var t;return null===(t=null==window?void 0:window.ue)||void 0===t?void 0:t.count(e,a)},s="adplacements",m=function(e){return e.startsWith(s)?e:"".concat(s,":").concat(e)}}),o("5BC6Z",function(a,t){e(a.exports,"getSlotWithBrowseNode",()=>i),e(a.exports,"getPlacementWithBrowseNode",()=>d);var r=/(\/b|\/s|\/l).*(node=)(\d{1,12})/,n=new Map,o=function(){if(!n.has(window.location.href)){var e=r.exec(window.location.href),a=e&&e[3]?e[3]:null;n.set(window.location.href,a)}return n.get(window.location.href)},i=function(e){var a=o();if(!e||!a)return null;var t=e.split(":");return t.splice(t.length-1,0,a),t.join(":")},d=function(e){var a=o();return a?"".concat(e,":").concat(a):null}}),o("9fPDQ",function(a,t){e(a.exports,"csmName",()=>r);var r=function(e){return e.replace(/_/g,":")}}),o("laNaz",function(a,t){e(a.exports,"feedbackCsaMetric",()=>r),e(a.exports,"feedbackCsmMetric",()=>o),n("2REd0"),n("8OaNj");let r={REQUEST:"adfeedback_request",SUCCESS:"adfeedback_success",ERROR:"adfeedback_error",LABEL_RENDERED_CREATIVE:"adfeedback_sponsoredlabelrendered_creative",LABEL_RENDERED_HOST:"adfeedback_sponsoredlabelrendered_host",LABEL_RENDERED_SERVER:"adfeedback_sponsoredlabelrendered_server"},o={REQUEST:"adfeedback:request",SUCCESS:"adfeedback:success",ERROR:"adfeedback:error",LABEL_RENDERED_CREATIVE:"adfeedback:sponsoredlabelrendered:creative",LABEL_RENDERED_HOST:"adfeedback:sponsoredlabelrendered:host",LABEL_RENDERED_SERVER:"adfeedback:sponsoredlabelrendered:server",LABEL_RENDERED:"adfeedback:sponsoredlabelrendered",TRANSPARENCY_INFO_MISSING:"adfeedback:transparencyinfo:missing"}}),o("8OaNj",function(a,t){e(a.exports,"incrementCsaPlacementCounter",()=>o);var r=n("4uzN4"),o=function(e,a,t){if(void 0===t&&(t=1),window.csa)try{window.csa("Events",{producerId:"adplacements"})("log",{schemaId:"ApeSafeframe.csaEvent.1",metricName:e+":"+a.name+":"+a.id,metricValue:t},{ent:"all"})}catch(e){(0,r.logError)("Error with 'logCsaEvent' CSA",e)}}}),o("4uzN4",function(a,t){e(a.exports,"logError",()=>r);var r=function(e,a){console.error(e),n("ERROR",e,o(e,a))},n=function(e,a,t){var r;null===(r=window.ueLogError)||void 0===r||r.call(window,t,{logLevel:e,attribution:"APE-safeframe",message:a+" | "})},o=function(e,a){return a instanceof Error?a:a?Error(a):Error(e)}});var i=n("2REd0"),d=n("laNaz"),l=n("8OaNj");class c{}c.startSafeFrameCSM=new Map,c.startSafeFrameCSA=new Map,c.startSafeFrameCSMMetrics=e=>{c.startSafeFrameCSM.set(e,new Date)},c.startSafeFrameCSAMetrics=e=>{c.startSafeFrameCSA.set(e,new Date)},c.labelRenderedServerSF=(e,a)=>{let t={id:a,name:e};(0,i.incrementCsmPlacementCounter)(d.feedbackCsmMetric.LABEL_RENDERED_SERVER,t),(0,i.incrementCsmCounter)(d.feedbackCsmMetric.LABEL_RENDERED),(0,l.incrementCsaPlacementCounter)(d.feedbackCsaMetric.LABEL_RENDERED_SERVER,t)};let s=(e,a)=>({slotId:e,wrapperDivId:`ape_${a}_wrapper`,placementDivId:`ape_${a}_placement`,iframeId:`ape_${a}_iframe`,textDivWrapperId:`ape_${a}_text-wrapper`,textDivId:`ape_${a}_text`,auiCardDeckId:`ape_${a}_aui_cardDeck`}),m="sf iframe ready";var u=function(e,a){if(void 0===a&&(a=document),""===e)return"";var t,r,n=null==a?void 0:a.getElementById("ape_".concat(e,"_placement_ClickTracking"));return null!==(r=null===(t=null==n?void 0:n.getAttribute)||void 0===t?void 0:t.call(n,"data-val"))&&void 0!==r?r:""};let f=(e,a=10,t=2e4)=>new Promise((r,n)=>{let o=Date.now(),i=setInterval(()=>{var a,d,l,c;e()?(null===(d=performance)||void 0===d||null===(a=d.mark)||void 0===a||a.call(d,"SafeFrame: Host found inside waitForWindowHostVariable"),clearInterval(i),r()):Date.now()-o>=t&&(clearInterval(i),null===(c=performance)||void 0===c||null===(l=c.mark)||void 0===l||l.call(c,"Timed out waiting for sf host in waitForWindowHostVariable"),n())},a)}),v=(e,a,t)=>new Promise(r=>{let n=t.getElementById(a);if(n){var o,i;null===(i=performance)||void 0===i||null===(o=i.mark)||void 0===o||o.call(i,`SafeFrame: idEl found before MutationObserver constructed ${a} `),r(n)}else new MutationObserver((e,n)=>{var o,i,d,l;let c=t.getElementById(a);c?(null===(l=performance)||void 0===l||null===(d=l.mark)||void 0===d||d.call(l,`SafeFrame: idEl found inside MutationObserver. ${a}`),n.disconnect(),r(c)):null===(i=performance)||void 0===i||null===(o=i.mark)||void 0===o||o.call(i,`SafeFrame: idEl NOT found during mutation. ${a}`)}).observe(e,{subtree:!0,childList:!0})}),w=(e,a)=>{var t,r;let n=`SafeFrame: Start fastSafeFrameLoad ${e}`;null===(r=performance)||void 0===r||null===(t=r.mark)||void 0===t||t.call(r,a?n+` (${a})`:n)};window.grandprix||(window.grandprix={metrics:c,wrappers:class{static listenForSFIFrameLoad(e,a,t,r=window){let n=e=>{var a;let t=r.document.getElementById(e),n=t.getAttribute("data-page-type"),o=t.getAttribute("data-subpage-type"),i=t.getAttribute("data-slot-name");return void 0===(a=r)&&(a=window),u([n,i,o].join("_"),a.document)},o=(e,a)=>{let t=n(e);return a.postMessage({command:"percolateClickTracking",data:t}),t},i=(e,n)=>{if(e.source===n.contentWindow&&e.data===m){var i,d,l,c;null==n||n.setAttribute("data-iframe-ready","true"),null===(d=performance)||void 0===d||null===(i=d.mark)||void 0===i||i.call(d,`SafeFrame: Start received sf ready message ${a}`);let s=null!==(c=e.ports[0])&&void 0!==c?c:null===(l=e.data)||void 0===l?void 0:l.messagePort,m=o(a,s);null==n||n.setAttribute("data-sent-percolate-click-tracking-params",m),this.fastSafeFrameLoad(a,`sf-host-load_${a}`,t,s,r)}},d=async t=>{if(t.data!==m)return;let n=r.document.getElementById(a);null!==n&&i(t,await v(n,e,r.document))};r.addEventListener("message",d)}static async fastSafeFrameLoad(e,a,t,r,n=window){try{w(e);let o=n.document,i=o.getElementById(e),d=i.getAttribute("data-scope"),l=i.getAttribute("data-placement-name"),m=s(l,d),u=o.getElementById(m.iframeId),v=u.getAttribute("data-arid"),E=JSON.parse(u.getAttribute("name"));t()||(w(e,"waitUntilElementExists"),await f(t)),t()?(w(e,"host exists"),t().secondPhaseLoadAd(v,E,r,c.startSafeFrameCSM.get(m.placementDivId),c.startSafeFrameCSA.get(m.placementDivId))):(w(e,"host doesn't exists"),o.getElementById(a).addEventListener("load",a=>{w(e,"SF host loaded"),t().secondPhaseLoadAd(v,E,r,c.startSafeFrameCSM.get(m.placementDivId),c.startSafeFrameCSA.get(m.placementDivId))}))}catch(e){var o,i;console.error(e),null===(o=(i=window).ueLogError)||void 0===o||o.call(i,e,{logLevel:"ERROR",attribution:"APE-safeframe",message:""})}}}})})();
    //# sourceMappingURL=grandprix.js.map
            ...
            try {
                if (window.ue && typeof window.ue.count === "function") {
                    window.ue.count("adplacements:adload:htmlreached:Gateway_right-7_desktop".replace(/_/g, ":"), 1);
                    window.ue.count("adplacements:adload:htmlreached:c17dcd70-7575-452d-b5ff-e605df521910", 1);
                }
                if (window.csa) {
                    window.csa("Events", {
                        ...
                        "log",
                        {
                            ...
                            metricName: "adload:htmlreached:Gateway_right-7_desktop:c17dcd70-7575-452d-b5ff-e605df521910",
                            metricValue: 1
                        },
                        { ent: "all" }
                    );
            ...
            window.grandprix.metrics.startSafeFrameCSMMetrics("ape_Gateway_right-7_desktop_placement");
            window.grandprix.metrics.startSafeFrameCSAMetrics("ape_Gateway_right-7_desktop_placement");
...
window.grandprix.wrappers.listenForSFIFrameLoad("ape_Gateway_right-7_desktop_iframe", "ape_Gateway_right-7_desktop_placement", (function() {return window.DAsf;}));
    //footer
